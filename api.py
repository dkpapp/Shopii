...
class ShopifyCheckoutSession:
    ...
    async def init_checkout(self, session) -> Tuple[bool, str]:
        ...
        # Changed from POST to GET: Browsers GET /checkout after cart additions.
        # POSTing without form payloads often drops the session or redirects back to the cart.
            ...
            'variables': {
                ...
                'delivery': {
                    'deliveryLines': [{
                        ...
                        # Universal Delivery Bypass: Force Shopify to dynamically auto-select the cheapest strategy.
                        # This mathematically prevents "DELIVERY_DELIVERY_LINE_DETAIL_CHANGED" errors caused by stale handles.
                        'selectedDeliveryStrategy': {
                            'deliveryStrategyMatchingConditions': {'estimatedTimeInTransit': {'any': True}, 'shipments': {'any': True}},
                            'options': {}
                        },
            ...
            'input': {
                ...
                'delivery': {
                    'deliveryLines': [{
                        ...
                        # Applied the same Universal Delivery Bypass to the final submit payload

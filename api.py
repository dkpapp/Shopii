...
def is_captcha_required(response_text: str) -> bool:
    ...
    return any(indicator.upper() in response_text.upper() for indicator in indicators)
        ...
        for _ in range(15):
            ...
            try:
                ...
                if tname == 'ProcessedReceipt': return True, "ORDER_PLACED"
                    ...
                    # Adapt to the server's requested pollDelay (in ms) to avoid rate limits
...
async def process_card_async(cc, mes, ano, cvv, site_url, variant_id=None, proxy_str=None) -> Tuple[bool, str, str, str, str, str, float, float]:
    ...
    try:
        ...
        async with aiohttp.ClientSession(connector=connector, timeout=timeout) as session:
            ...
            if not ok:
                # Deep Cache invalidation fallback for stale/out-of-stock variants
                with _cache_lock:
